export const metadata = { title: "Algorithm Visualizer", date: "2025.07.15", description: "A write up on the background and details of building this site.", }
...
## Structure
The structure of this project is fairly straight forward. I tried to keep logic relatively de-coupled between interactable UI components & the visualizer itself. Thus,
...
3. The grid is intialized and added to the canvas.
