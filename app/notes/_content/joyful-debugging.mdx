...
Over the past year, I've been lucky enough to work with some incredibly talented engineers and I've learned a lot from them. Here are two of the smaller tidbits I've learned.
...
Historically, I was a diehard print statement abuser. Whenever I was developing, I'd scatter print statements everywhere, drown in logs, and develop an impressive headache in the process.
...
### TL;DR
- Learn when and how to use a debugger.
